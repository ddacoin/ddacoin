...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/ddacoin/ddacoin/netsync)
...
```bash
$ go get -u github.com/ddacoin/ddacoin/netsync
```
