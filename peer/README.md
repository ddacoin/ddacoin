...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/ddacoin/ddacoin/peer)
...
```bash
$ go get -u github.com/ddacoin/ddacoin/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/ddacoin/ddacoin/peer#example-package--NewOutboundPeer)  
