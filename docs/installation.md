...
* Install the MSI available at: [btcd windows installer](https://github.com/ddacoin/ddacoin/releases)
...
```bash
git clone https://github.com/ddacoin/ddacoin $GOPATH/src/github.com/ddacoin/ddacoin
cd $GOPATH/src/github.com/ddacoin/ddacoin
go install -v . ./cmd/...
```
...
* [Using bootstrap.dat](https://github.com/ddacoin/ddacoin/blob/master/docs/configuration.md#using-bootstrapdat)
