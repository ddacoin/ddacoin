...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/ddacoin/ddacoin/mempool)
...
```bash
$ go get -u github.com/ddacoin/ddacoin/mempool
```
