...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/ddacoin/ddacoin/connmgr)
...
```bash
$ go get -u github.com/ddacoin/ddacoin/connmgr
```
